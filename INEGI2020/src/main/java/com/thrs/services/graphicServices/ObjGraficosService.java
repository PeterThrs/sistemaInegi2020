...
public class ObjGraficosService {
    ...
    /**
     * Descripción: Esta función se encarga de construir un objeto gráfico tipo
     * JPanel.
     *
     ...
     * @throws null : Si construye un JPanel sin color de fondo o borde envíe un
     * [null] como parámetro.
     */
     ...
     * JScrollPane.
     *
     * @param componente (Component): Objeto gráfico que contiene el
     * JScrollPane.
     * @param x (int): Posición inicial en pixeles sobre el eje X.
     * @param y (int): Posición inicial en pixeles sobre el eje Y.
     ...
     * @throws null : Si construye un JScrollPane sin color de fondo o borde
     * envíe un [null] como parámetro.
     */
     ...
     * @param cursor (Cursor): Tipo de cursor que se muestra al pasar sobre el
     * botón.
     ...
     * @param direccion (String): Dirección de los elementos dentro del botón
     * siendo:
     * <ul>
     * <li>'c' (CENTER): Contenido centrado (por defecto).</li>
     * <li>'t' (TOP): Contenido centrado con texto arriba de una imágen.</li>
     * <li>'l' (LEFT): Contenido en la izquierda [Si tiene imágen y texto la
     * imágen se posiciona primero].</li>
     * <li>'r' (RIGHT): Contenido en la derecha [Si tiene imágen y texto el
     * texto se posiciona primero].</li>
     * <li>'b' (BOTTOM): Contenido centrado con texto abajo de una imágen.</li>
     * </ul>
     * @param esSolido (boolean): Booleano que indica si el boton tiene color de
     * fondo (true) o tiene fondo transparente (false).
     * @return boton (JButton): Objeto gráfico tipo JButton.
     * @throws null : Si construye un JButton sin texto, cursor, imagen, fuente,
     * colorFondo, colorFuente o borde envíe un [null] como parámetro.
     */
     ...
     * @param colorFuente (Color): Color de la letra o ForeGround del
     * radioButton.
     * @return radioButton (JButton): Objeto gráfico tipo JRadioButton.
     * @throws null : Si construye un JRadioButton sin texto, cursor, fuente, o
     * colorFuente envíe un [null] como parámetro.
     */
     ...
     * @throws null : Si construye un JCheckBox sin texto, cursor, fuente, o
     * colorFuente envíe un [null] como parámetro.
     */
     ...
     * @param direccion (String): Dirección de los elementos dentro del label
     * siendo:
     * <ul>
     * <li>'l' (LEFT): Contenido en la izquierda (por defecto).</li>
     * <li>'c' (CENTER): Contenido centrado [Si tiene imágen y texto la imágen
     * se posiciona primero].</li>
     * <li>'t' (TOP): Contenido centrado con texto arriba de una imágen.</li>
     * <li>'r' (RIGHT): Contenido en la derecha [Si tiene imágen y texto el
     * texto se posiciona primero].</li>
     * <li>'b' (BOTTOM): Contenido centrado con texto abajo de una imágen.</li>
     ...
     * @throws null : Si construye un JLabel sin texto, cursor, imagen, fuente,
     * colorFondo, colorFuente o borde envíe un [null] como parámetro.
     */
     ...
     * @param direccion (String): Dirección de los elementos dentro del
     * textField siendo:
     * <ul>
     * <li>'l' (LEFT): Contenido en la izquierda (por defecto).</li>
     ...
     * @throws null : Si construye un JTextField sin texto, fuente, colorFondo,
     * colorFuente, colorCaret o borde envíe un [null] como parámetro.
     */
     ...
     * @param fuente (Font): Tipo de fuente que tendrá el texto del
     * passwordField.
     ...
     * @param direccion (String): Dirección de los elementos dentro del
     * passwordField siendo:
     * <ul>
     * <li>'l' (LEFT): Contenido en la izquierda (por defecto).</li>
     * <li>'c' (CENTER): Contenido centrado.</li>
     * <li>'r' (RIGHT): Contenido en la derecha.</li>
     * </ul>
     * @return passwordField (JPasswordField): Objeto gráfico tipo
     * JPasswordField.
     * @throws null : Si construye un JPasswordField sin texto, fuente,
     * colorFondo, colorFuente, colorCaret o borde envíe un [null] como
     * parámetro.
     */
     ...
     * @throws null : Si construye un JTextArea sin texto, fuente, colorFondo,
     * colorFuente, colorCaret o borde envíe un [null] como parámetro.
     */
     ...
     * JComboBox.
     *
     * @param cadena (String): Todas las opciones que tendrá el comboBox, para
     * enviar varias opciones separe cada opcion con un "_".
     * @param x (int): Posición inicial en pixeles sobre el eje X.
     * @param y (int): Posición inicial en pixeles sobre el eje Y.
     ...
     * @param direccion (String): Dirección de los elementos dentro del comboBox
     * siendo:
     * <ul>
     * <li>'l' (LEFT): Contenido en la izquierda (por defecto).</li>
     * <li>'c' (CENTER): Contenido centrado.</li>
     ...
     * @throws null : Si construye un JComboBox sin texto, fuente, colorFondo o
     * colorFuente envíe un [null] como parámetro.
     */
     ...
     */
    public <T extends JComponent> GridBagConstraints getGridBagConstraints(int gridx, int gridy, int gridWidth, int gridHeight,
