 ...
 * @author Usuario
 */
public class TablaLocalidadesPanelTemplateTransaccional extends JPanel {
    ...
    private String[] cabecera = {"Id Entidad","Id Municipio","Id Localidad", "Nombre de Entidad"};

    public TablaLocalidadesPanelTemplateTransaccional(TablaLocalidadesPanelControllerTransaccional tablaLocalidadesPanelControllerTransaccional) {
        this.tablaLocalidadesPanelControllerTransaccional = tablaLocalidadesPanelControllerTransaccional;
    ...
    public void crearJTable() {
        ...
        modelo = new ModelLocalidad();
        modelo.setColumnIdentifiers(cabecera);

        tabla = new JTable();
        tabla.setModel(modelo);
        tabla.addMouseListener(tablaLocalidadesPanelControllerTransaccional);
        ...
        btnAnterior.addMouseListener(tablaLocalidadesPanelControllerTransaccional);
        btnAnterior.addActionListener(tablaLocalidadesPanelControllerTransaccional);
        ...
        btnSiguiente.addMouseListener(tablaLocalidadesPanelControllerTransaccional);
        btnSiguiente.addActionListener(tablaLocalidadesPanelControllerTransaccional);
    ...
    public ModelLocalidad getModelo() {
        return modelo;
    }
