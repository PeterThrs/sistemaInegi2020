 ...
 * @author Usuario
 */
public class FormularioEntidadesPanelTemplateTransaccional extends JPanel {
    ...
    public FormularioEntidadesPanelTemplateTransaccional(FormularioEntidadesPanelControllerTransaccional formularioEntidadesPanelControllerTransaccional) {
        this.formularioEntidadesPanelControllerTransaccional = formularioEntidadesPanelControllerTransaccional;
    ...
    public void crearContenidoPDatos() {
        ...
        tIdEntidad.addFocusListener(formularioEntidadesPanelControllerTransaccional);
        ...
        tNomEntidad.addFocusListener(formularioEntidadesPanelControllerTransaccional);
