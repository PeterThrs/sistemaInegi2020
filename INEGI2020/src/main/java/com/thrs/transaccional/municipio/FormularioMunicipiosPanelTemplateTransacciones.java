 ...
 * @author Usuario
 */
public class FormularioMunicipiosPanelTemplateTransacciones extends JPanel {
    ...
    public FormularioMunicipiosPanelTemplateTransacciones(FormularioMunicipiosPanelControllerTransacciones formularioMunicipiosPanelControllerTransacciones) {
        this.formularioMunicipiosPanelControllerTransacciones = formularioMunicipiosPanelControllerTransacciones;
    ...
    public void crearContenidoPDatos() {
        ...
        tIdEntidad.addFocusListener(formularioMunicipiosPanelControllerTransacciones);
        ...
        tIdMunicipio.addFocusListener(formularioMunicipiosPanelControllerTransacciones);
        //gbc = grid(1, 2, 1, 1, 0, 0, GridBagConstraints.BOTH, GridBagConstraints.CENTER, new Insets(10, 10, 10, 10), 0, 0);
        ...
        tNomEntidad.addFocusListener(formularioMunicipiosPanelControllerTransacciones);
