 ...
 * @author Usuario
 */
public class FormularioLocalidadesPanelTemplate extends JPanel {
    ...
    public FormularioLocalidadesPanelTemplate(FormularioLocalidadesPanelController formularioLocalidadesPanelController) {
        this.formularioLocalidadesPanelController = formularioLocalidadesPanelController;
    ...
    public void crearContenidoPDatos() {
        ...
        tIdEntidad.addFocusListener(formularioLocalidadesPanelController);
        ...
        tIdMunicipio.addFocusListener(formularioLocalidadesPanelController);
        //gbc = grid(1, 2, 1, 1, 0, 0, GridBagConstraints.BOTH, GridBagConstraints.CENTER, new Insets(10, 10, 10, 10), 0, 0);
        ...
        tIdLocalidad.addFocusListener(formularioLocalidadesPanelController);
        //gbc = grid(1, 2, 1, 1, 0, 0, GridBagConstraints.BOTH, GridBagConstraints.CENTER, new Insets(10, 10, 10, 10), 0, 0);
        ...
        tNomLocalidad.addFocusListener(formularioLocalidadesPanelController);
