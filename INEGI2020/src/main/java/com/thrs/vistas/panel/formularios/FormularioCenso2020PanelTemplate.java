 ...
 * @author Usuario
 */
public class FormularioCenso2020PanelTemplate extends JPanel {

    private FormularioCenso2020PanelController formularioCenso2020PanelController;
    private JLabel lInstrucciones, lEslogan, lTitulo, lIdEntidad,lIdMunicipio, lIdLocalidad, lPobTotal, lPobMas, lPobFem;
    private JTextField tIdEntidad,tIdMunicipio, tIdLocalidad, tPobTotal, tPobMas, tPobFem;
    ...
    public FormularioCenso2020PanelTemplate(FormularioCenso2020PanelController formularioCenso2020PanelController) {
        this.formularioCenso2020PanelController = formularioCenso2020PanelController;
    ...
    public void crearContenidoPDatos() {
        ...
        tIdEntidad.addFocusListener(formularioCenso2020PanelController);
        ...
        tIdMunicipio.addFocusListener(formularioCenso2020PanelController);
        //gbc = grid(1, 2, 1, 1, 0, 0, GridBagConstraints.BOTH, GridBagConstraints.CENTER, new Insets(10, 10, 10, 10), 0, 0);
        ...
        tIdLocalidad.addFocusListener(formularioCenso2020PanelController);
        //gbc = grid(1, 2, 1, 1, 0, 0, GridBagConstraints.BOTH, GridBagConstraints.CENTER, new Insets(10, 10, 10, 10), 0, 0);
        ...
        tPobTotal.addFocusListener(formularioCenso2020PanelController);
        ...
        this.add(lPobFem, gbc);

        // TEXTFIELD POB FEMENINA ----------------------------------------------------------------
        ...
        tPobFem.addFocusListener(formularioCenso2020PanelController);
        //gbc = grid(1, 3, 1, 1, 0, 0, GridBagConstraints.BOTH, GridBagConstraints.CENTER, new Insets(10, 10, 10, 10), 0, 0);
        ...
        this.add(tPobFem, gbc);
        
        
        // LABEL POB MASCULINA ----------------------------------------------------------------
        lPobMas = sObjGraficos.construirJLabel(
                "Poblacion Masculina:",
                20, 180, 160, 30,
                null, null,
                sRecursos.getFontLigera(),
        ...
        this.add(lPobMas, gbc);

        // TEXTFIELD POB MASCULINA ----------------------------------------------------------------
        tPobMas = sObjGraficos.construirJTextField(
                "Cantidad",
                30, 215, 180, 30,
                sRecursos.getFontLigera(),
                colorGris,
        ...
        tPobMas.addFocusListener(formularioCenso2020PanelController);
        //gbc = grid(1, 3, 1, 1, 0, 0, GridBagConstraints.BOTH, GridBagConstraints.CENTER, new Insets(10, 10, 10, 10), 0, 0);
