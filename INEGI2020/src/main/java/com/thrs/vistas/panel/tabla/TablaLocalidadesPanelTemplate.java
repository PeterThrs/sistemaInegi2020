 ...
 * @author Usuario
 */
public class TablaLocalidadesPanelTemplate extends JPanel {
    ...
    public TablaLocalidadesPanelTemplate(TablaLocalidadesPanelController tablaLocalidadesPanelController) {
        this.tablaLocalidadesPanelController = tablaLocalidadesPanelController;
    ...
    public void crearJTable() {
        ...
        tabla.addMouseListener(tablaLocalidadesPanelController);
        ...
        btnAnterior.addMouseListener(tablaLocalidadesPanelController);
        btnAnterior.addActionListener(tablaLocalidadesPanelController);
        ...
        btnSiguiente.addMouseListener(tablaLocalidadesPanelController);
        btnSiguiente.addActionListener(tablaLocalidadesPanelController);
